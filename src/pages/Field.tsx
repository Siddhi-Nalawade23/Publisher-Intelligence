   ...
   return (
      <div>
         ...
         <div className="asks-card">
            ...
            <div className="asks">
               <div className="ask">Which adoptions do I defend in the next three weeks?</div>
               <div className="ask">Did I lose the course, or did the course lose sections?</div>
               <div className="ask">Where is my rep walking in blind this week?</div>
               <div className="ask">Which wins should the region be repeating?</div>
            </div>
